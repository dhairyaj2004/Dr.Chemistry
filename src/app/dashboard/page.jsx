        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          ...
          <div className="max-w-lg p-4 mx-auto md:mx-4 lg:mx-4 rounded-lg shadow-lg overflow-hidden">
            ...
            <p className="p-2 text-base md:text-xl text-neutral-300 max-w-lg mx-auto text-justify">
              ...
              involves the condensation of the acid and alcohol molecules.
              It&apos;s widely used in making fragrances, flavors, and
              pharmaceuticals due to its ability to produce aromatic esters.
            </p>
          </div>
        </div>
      </div>
