...
export async function PUT(req) {
  try {
    ...
    return NextResponse.json({ message: 'Thread updated successfully', thread: updatedThread }, { status: 200 });
  } catch (error) {
...
export async function DELETE(req) {
  try {
    ...
    return NextResponse.json({ message: 'Thread deleted successfully', thread: deletedThread }, { status: 200 });
  } catch (error) {
