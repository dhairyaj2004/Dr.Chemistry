...
<div className='flex flex-col min-h-screen justify-center items-center bg-gradient-to-b from-gray-950 to-gray-900'>
  ...
  <div className="space-y-4 text-lg text-red-100">
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>1. Introduction to Biochemistry</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>2. Biomolecules: Carbohydrates</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>3. Biomolecules: Lipids</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>4. Biomolecules: Proteins</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>5. Biomolecules: Nucleic Acids</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>6. Enzymes and Enzyme Kinetics</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>7. Metabolism: Overview</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>8. Glycolysis and Gluconeogenesis</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>9. Citric Acid Cycle (Krebs Cycle)</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>10. Oxidative Phosphorylation and Electron Transport Chain</p>
    <p className='min-w-screen bg-zinc-800 shadow-lg rounded-lg text-left text-2xl '>11. Pentose Phosphate Pathway</p>
