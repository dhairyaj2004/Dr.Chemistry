  ...
  }) 
  {
    return (
      ...
      <div className="max-w-4xl mx-auto p-10 text-center rounded-md bg-gradient-to-tr from-gray-900 to-black shadow-xl border border-purple-700">
        <div className="mb-10">
          <h1 className="text-4xl md:text-4xl lg:text-4xl text-green-400 font-extrabold mb-2">Congratulations!</h1>
          <h2 className="text-xl md:text-2xl lg:text-2xl text-gray-300">You've successfully bought the course for just</h2>
