...
function reviewSec() {
  return (
    ...
    <p className="mb-12 text-lg text-center text-teal-300">Here is a few of the honest feedbacks of our users.</p>
            ...
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                <div className="relative h-full ml-0 mr-0 sm:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg">
                        ...
                        <p className="mb-2 text-gray-600">Excellent teaching technique, engaging and clear. Material is comprehensive and relevant. Teachers offer great support, always available to clarify doubts and encourage learning.</p>
                    </div>
                </div>
            </div>
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                <div className="relative h-full ml-0 mr-0 sm:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg">
                        ...
                        <p className="mb-2 text-gray-600">Innovative teaching methods make learning enjoyable. Study materials are extensive and well-organized. Teachers are supportive, providing guidance and feedback promptly to enhance understanding.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                <div className="relative h-full ml-0 mr-0 sm:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg">
                        ...
                        <p className="mb-2 text-gray-600">Engaging teaching strategies boost comprehension. Study materials are detailed and aid in understanding concepts thoroughly. Teachers provide valuable support, ensuring students grasp challenging topics with confidence.</p>
                    </div>
                </div>
            </div>
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
