  ...
  return (
    ...
    <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 bg-black/15">
      <Spotlight
        ...
        fill="white"
      />
      <div className="p-4 mt-10 flex flex-col z-10 align-middle justify-center items-center h-screen">
        <div className=" mt-5 sm:mt-10 md:mt-20 md:text-7xl  sm:text-6xl text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
        ...
        <p className="mt-7 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto text-justify">
