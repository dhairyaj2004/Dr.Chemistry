...
//   return (
//     <>
//     <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0  bg-gradient-to-b from-black/15 to-gray-900">
//       <Spotlight
//         className="-top-40 left-0 md:left-60 md:-top-20"
//         fill="white"
//       />
//       <div className="py-10 mt-8 flex flex-col z-10 align-middle justify-center items-center h-screen">
    ...
    <>
      <div className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden py-10 md:py-0 bg-gradient-to-b from-black/15 to-gray-900">
        ...
        <div className="py-10 flex flex-col z-10 align-middle justify-center items-center">
          ...
          <TypewriterEffect className="mt-9" words={words} />
          <p className="mt-8 px-2 text-base md:text-xl text-neutral-300 max-w-lg mx-auto text-justify">
            "Welcome to our comprehensive chemistry website, your gateway to exploring the diverse realms of this fascinating science. From the intricate world of organic compounds to the fundamental principles of physical chemistry, embark on a journey through the vast spectrum of chemical disciplines. Discover, learn, and delve into the wonders of chemistry with us."
          </p>

          <div className="md:flex md:gap-7 lg:flex lg:gap-10 flex flex-col gap-5 items-center sm:flex-row sm:justify-center sm:gap-5 mt-10">
            <Link href="/Images">
              <Button borderRadius="1.75rem" className="font-medium dark:bg-black text-black dark:text-red-300 border-neutral-200 dark:border-slate-800 font-weight-2 rounded-lg">
                Chemistry Gallery
              </Button>
            </Link>
            <Link href="/Videos">
            ...
            <Link href="/dashboard">
              <Button borderRadius="1.75rem" className="font-medium dark:bg-black text-black dark:text-red-300 border-neutral-200 dark:border-slate-800 rounded-lg">
                Dashboard
              </Button>
            </Link>
          </div>
