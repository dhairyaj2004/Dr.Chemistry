...
const content = [
  {
    ...
    "title": "Why is our website the ultimate resource for chemistry enthusiasts?",
    ...
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white">
        <img className="rounded-xl px-1" src="https://t4.ftcdn.net/jpg/05/63/41/63/360_F_563416386_ruJPhBmQZTDGN90VyCbDFMnVy5sbwkeb.jpg" alt="img" />
      </div>
    ),
  },
  {
    "title": "How does our website ensure high-quality and reliable content?",
    "description": "We collaborate with experienced chemists and educators to create and review all content on our website. Our team is dedicated to providing accurate, scientifically sound information, regularly updating our resources to reflect the latest advancements in the field. This commitment to quality ensures that our users can trust the information they find here.",
    content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <img className="rounded-xl px-1" src="https://t4.ftcdn.net/jpg/05/52/90/05/360_F_552900530_D4WF1c3zGsvIGfLgKaRBrEmbvPlk6O6E.jpg" alt="img" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] flex items-center justify-center text-white">
        <img className="rounded-xl px-1" src="https://www.thoughtco.com/thmb/6MsMmUK27akFhb8i89kj95J5iko=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-545286316-433dd345105e4c6ebe4cdd8d2317fdaa.jpg" alt="img" />
      </div>
    ),
  }
];
